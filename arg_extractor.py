...
def get_args():
    ...
    # argument added from MixMatch <begin>
    parser.add_argument('--lr', '--learning-rate', default=0.002, type=float,
                        metavar='LR', help='initial learning rate')
    parser.add_argument('--n-labeled', type=int, default=250,
                        help='Number of labeled data')
    parser.add_argument('--num_incorrect', type=int, default=0,
                        help='Number of incorrect labels')
    ...
    parser.add_argument('--arc', nargs="?", type=str, default=None,
                        help='')
    parser.add_argument('--lr_decay', nargs="?", type=str, default=None,
                        help='')
    parser.add_argument('--vqorder', nargs="?", type=str, default=None,
                        help='')
